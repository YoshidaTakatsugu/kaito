      ...
      <div className="mx-auto grid w-full max-w-7xl gap-16">
          ...
          <div className="border-y border-[#001f3f]/15">
            {coachAchievements.map((achievement) => (
              <div
                ...
                className="grid gap-3 border-b border-[#001f3f]/10 py-5 last:border-b-0 sm:grid-cols-[0.36fr_1fr_0.34fr]"
              >
        ...
        <section className="grid gap-5 md:grid-cols-3">
          {[
            ...
            <article key={item.label} className="border-t border-[#001f3f]/15 pt-6">
